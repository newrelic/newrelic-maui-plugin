...
/// \param errorData The raw error data from the queue
///
///
/// returns:
/// The formatted event as it would be sent over the wire
- (NSDictionary<NSString *, id> * _Nonnull)formatErrorAsEventForTesting:(NSDictionary<NSString *, id> * _Nonnull)errorData SWIFT_WARN_UNUSED_RESULT;
